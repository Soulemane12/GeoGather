      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <div className="flex space-x-2">
            {[
              ...
              { value: 'pro' as const, label: 'Pro (25mi)', color: 'bg-orange-100 text-orange-700' },
              { value: 'premium' as const, label: 'Premium (∞)', color: 'bg-gray-200 text-gray-800' }
            ].map((planOption) => (
              <button
                ...
                className={`px-3 py-2 text-xs font-medium rounded-lg transition-all ${
                  currentPlan === planOption.value
                    ? `${planOption.color} ring-2 ring-offset-2 ring-orange-500`
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 text-base bg-white/80 backdrop-blur-sm"
            disabled={loading}
          />
        </div>
        ...
        <button
          ...
          className="w-full bg-gradient-to-r from-orange-500 to-gray-800 text-white py-3 px-6 rounded-xl hover:from-orange-600 hover:to-black disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 font-semibold text-base shadow-lg"
        >
